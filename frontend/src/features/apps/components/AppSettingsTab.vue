  ...
  <div class="space-y-6">
    ...
    <div class="bg-panel border border-b1 rounded-xl p-5 space-y-4">
      ...
      <div class="space-y-1.5">
        ...
        />
        <p class="text-xs text-t3">Reassign this app to a different project, or remove it from any project.</p>
      </div>
    ...
    <div class="bg-panel border border-fail/40 rounded-xl p-5 space-y-3">
      ...
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-xs text-t3 mt-0.5">Permanently removes the app, its CI pipeline, and its repository. This cannot be undone.</p>
        </div>
        <button
