...
export const teamsApi = {
  ...
  addMember: (id: number, data: AddMemberRequest) => api.post<TeamMember>(`/teams/${id}/members`, data),
  removeMember: (teamId: number, memberId: number) => api.delete(`/teams/${teamId}/members/${memberId}`),
};
